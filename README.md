...
Executor --> LLM[OpenAI LLM]
Executor --> TTS[OpenAI TTS]
...
This allows horizontal scaling by running multiple application instances.
...
- Automatic recovery of stuck `Processing` jobs is not implemented in the current version.
...
Iteration documents are preserved as historical implementation records:

- `docs/codex/ITERATION_00.md`
- `docs/codex/ITERATION_01.md`
- `docs/codex/ITERATION_02.md`
- `docs/codex/ITERATION_03.md`
- `docs/codex/ITERATION_04.md`
- `docs/codex/ITERATION_05.md`
- `docs/codex/ITERATION_06.md`
